...
Gem::Specification.new do |spec|
  ...
  spec.description = "Minimal APM for Rails apps. Automatically measures each controller action's total time and posts it to a remote endpoint with an API key read from your app's settings/credentials/env."
